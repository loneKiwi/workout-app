...
function SheetClose({
  ...
  return (
    <SheetPrimitive.Close
      ...
      className="focus:outline-none outline-none focus:ring-0 ring-0"
      {...props}
    />
  );
}
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'p-3 data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-none transition ease-in-out data-[state=closed]:duration-150 data-[state=open]:duration-150',
          side === 'right' &&
        ...
        {...props}
      >
        <div className="relative border rounded-lg bg-popover backdrop-blur-md w-full flex-1">
          {children}
          {!hideClose && (
